...
class StateMasterGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the StateMaster entity")
        ...
        .repeat(2) {
            ...
            .get("/services/documents/api/state-masters")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new stateMaster")
            .post("/services/documents/api/state-masters")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
            ...
            .repeat(5) {
                ...
                .get("/services/documents${new_stateMaster_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created stateMaster")
            .delete("/services/documents${new_stateMaster_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
