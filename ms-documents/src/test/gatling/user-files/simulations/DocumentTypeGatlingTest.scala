...
class DocumentTypeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the DocumentType entity")
        ...
        .repeat(2) {
            ...
            .get("/services/documents/api/document-types")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new documentType")
            .post("/services/documents/api/document-types")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
            ...
            .repeat(5) {
                ...
                .get("/services/documents${new_documentType_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created documentType")
            .delete("/services/documents${new_documentType_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
