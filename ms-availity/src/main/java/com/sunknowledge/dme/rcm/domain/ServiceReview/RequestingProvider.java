...
@JsonPropertyOrder({ "specialtyCode", "lastName", "firstName", "middleName", "suffix", "npi", "taxId",
		"payerAssignedProviderId", "submitterId", "addressLine1", "addressLine2", "city", "stateCode", "zipCode",
		"contactName", "phone", "extension", "fax" })
