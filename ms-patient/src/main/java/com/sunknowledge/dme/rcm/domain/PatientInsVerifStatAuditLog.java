...
/**
 * A PatientInsVerifStatAuditLog.
 */
@Table("t_patient_ins_verif_stat_audit_log")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PatientInsVerifStatAuditLog implements Serializable {
    ...
    public PatientInsVerifStatAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public Long getInsrnceVrifId() {
        return this.insrnceVrifId;
    }

    public PatientInsVerifStatAuditLog insrnceVrifId(Long insrnceVrifId) {
        this.setInsrnceVrifId(insrnceVrifId);
        return this;
    }
    ...
    public PatientInsVerifStatAuditLog oldRowData(String oldRowData) {
    ...
    public PatientInsVerifStatAuditLog newRowData(String newRowData) {
    ...
    public PatientInsVerifStatAuditLog dmlType(String dmlType) {
    ...
    public PatientInsVerifStatAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public PatientInsVerifStatAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PatientInsVerifStatAuditLog)) {
            return false;
        }
        return id != null && id.equals(((PatientInsVerifStatAuditLog) o).id);
    }
