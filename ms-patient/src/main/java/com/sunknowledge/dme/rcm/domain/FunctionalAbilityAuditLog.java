...
/**
 * A FunctionalAbilityAuditLog.
 */
@Table("t_functional_ability_audit_log")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FunctionalAbilityAuditLog implements Serializable {
    ...
    public FunctionalAbilityAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public Long getFunalAbityId() {
        return this.funalAbityId;
    }

    public FunctionalAbilityAuditLog funalAbityId(Long funalAbityId) {
        this.setFunalAbityId(funalAbityId);
        return this;
    }
    ...
    public FunctionalAbilityAuditLog oldRowData(String oldRowData) {
    ...
    public FunctionalAbilityAuditLog newRowData(String newRowData) {
    ...
    public FunctionalAbilityAuditLog dmlType(String dmlType) {
    ...
    public FunctionalAbilityAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public FunctionalAbilityAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FunctionalAbilityAuditLog)) {
            return false;
        }
        return id != null && id.equals(((FunctionalAbilityAuditLog) o).id);
    }
