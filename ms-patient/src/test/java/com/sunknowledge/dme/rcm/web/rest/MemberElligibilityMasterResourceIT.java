...
class MemberElligibilityMasterResourceIT {
    ...
    private static final Long DEFAULT_TRADING_PARTNER_SERVICE_ID = 1L;
    private static final Long UPDATED_TRADING_PARTNER_SERVICE_ID = 2L;
    ...
    void createMemberElligibilityMaster() throws Exception {
        ...
        MemberElligibilityMasterDTO memberElligibilityMasterDTO = memberElligibilityMasterMapper.toDto(memberElligibilityMaster);
        webTestClient
            .post()
            .uri(ENTITY_API_URL)
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(TestUtil.convertObjectToJsonBytes(memberElligibilityMasterDTO))
            .exchange()
            .expectStatus()
            .isCreated();
    ...
    void getAllMemberElligibilityMasters() {
        ...
        webTestClient
            ...
            .value(hasItem(DEFAULT_TRADING_PARTNER_SERVICE_ID.intValue()))
    ...
    void getMemberElligibilityMaster() {
        ...
        webTestClient
            ...
            .jsonPath("$.tradingPartnerServiceId")
            .value(is(DEFAULT_TRADING_PARTNER_SERVICE_ID.intValue()))
            .jsonPath("$.tradingPartnerName")
    ...
    void putExistingMemberElligibilityMaster() throws Exception {
        ...
        updatedMemberElligibilityMaster
            ...
            .updatedDate(UPDATED_UPDATED_DATE)
            .memberElligibilityMasterUuid(UPDATED_MEMBER_ELLIGIBILITY_MASTER_UUID);
        MemberElligibilityMasterDTO memberElligibilityMasterDTO = memberElligibilityMasterMapper.toDto(updatedMemberElligibilityMaster);

        webTestClient
            .put()
            .uri(ENTITY_API_URL_ID, memberElligibilityMasterDTO.getClaimElligibilityMasterId())
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(TestUtil.convertObjectToJsonBytes(memberElligibilityMasterDTO))
            .exchange()
            .expectStatus()
