...
/**
 * Performance test for the ChecklistCoverageCriteriaMap entity.
 */
class ChecklistCoverageCriteriaMapGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ChecklistCoverageCriteriaMap entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all checklistCoverageCriteriaMaps")
            .get("/services/salesorder/api/checklist-coverage-criteria-maps")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new checklistCoverageCriteriaMap")
            .post("/services/salesorder/api/checklist-coverage-criteria-maps")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "checklistId":"0"
                , "checklistName":"SAMPLE_TEXT"
                , "coverageCriteriaId":"0"
                , "coverageCriteriaDetails":"SAMPLE_TEXT"
                , "status":"SAMPLE_TEXT"
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created checklistCoverageCriteriaMap")
                .get("/services/salesorder${new_checklistCoverageCriteriaMap_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created checklistCoverageCriteriaMap")
            .delete("/services/salesorder${new_checklistCoverageCriteriaMap_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
