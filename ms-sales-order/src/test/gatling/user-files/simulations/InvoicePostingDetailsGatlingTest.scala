...
/**
 * Performance test for the InvoicePostingDetails entity.
 */
class InvoicePostingDetailsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the InvoicePostingDetails entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all invoicePostingDetails")
            .get("/services/salesorder/api/invoice-posting-details")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new invoicePostingDetails")
            .post("/services/salesorder/api/invoice-posting-details")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "itemId":"0"
                , "postingDate":"2020-01-01T00:00:00.000Z"
                , "postedById":"0"
                , "postedByName":"SAMPLE_TEXT"
                , "postingComment":"SAMPLE_TEXT"
                , "postType":"SAMPLE_TEXT"
                , "depositId":"SAMPLE_TEXT"
                , "receiptId":"SAMPLE_TEXT"
                , "postAmount":"0"
                ...
                , "invoicePostingDetailsUuid":null
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created invoicePostingDetails")
                .get("/services/salesorder${new_invoicePostingDetails_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created invoicePostingDetails")
            .delete("/services/salesorder${new_invoicePostingDetails_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
