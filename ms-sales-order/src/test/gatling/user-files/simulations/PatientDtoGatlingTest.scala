...
class PatientDtoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the PatientDto entity")
        ...
        .repeat(2) {
            ...
            .get("/services/salesorder/api/patient-dtos")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new patientDto")
            .post("/services/salesorder/api/patient-dtos")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "patientId":"0"
            ...
            .repeat(5) {
                ...
                .get("/services/salesorder${new_patientDto_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created patientDto")
            .delete("/services/salesorder${new_patientDto_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
