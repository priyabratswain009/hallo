...
/**
 * Performance test for the SecondaryClaimSubmisionMaster entity.
 */
class SecondaryClaimSubmisionMasterGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the SecondaryClaimSubmisionMaster entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all secondaryClaimSubmisionMasters")
            .get("/services/salesorder/api/secondary-claim-submision-masters")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new secondaryClaimSubmisionMaster")
            .post("/services/salesorder/api/secondary-claim-submision-masters")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "salesOrderId":"0"
                ...
                , "insertedById":"SAMPLE_TEXT"
                , "insertedDate":"2020-01-01T00:00:00.000Z"
                , "billingProviderType":"SAMPLE_TEXT"
                , "insertedByName":"SAMPLE_TEXT"
                , "status":"SAMPLE_TEXT"
                , "otherSubscriberAddress1":"SAMPLE_TEXT"
                , "otherSubscriberAddress2":"SAMPLE_TEXT"
                , "otherSubscriberCity":"SAMPLE_TEXT"
                , "otherSubscriberState":"SAMPLE_TEXT"
                , "otherSubscriberZip":"SAMPLE_TEXT"
                , "otherInsuredQualifier":"SAMPLE_TEXT"
                , "otherInsuredLastName":"SAMPLE_TEXT"
                , "otherInsuredFirstName":"SAMPLE_TEXT"
                , "otherInsuredIdentifierTypeCode":"SAMPLE_TEXT"
                , "otherInsuredIdentifier":"SAMPLE_TEXT"
                , "otherPayerOrganizationName":"SAMPLE_TEXT"
                , "otherPayerIdentifierTypeCode":"SAMPLE_TEXT"
                , "otherPayerIdentifier":"SAMPLE_TEXT"
                , "otherPayerAdjudicationOrPaymentDate":"2020-01-01T00:00:00.000Z"
                , "otherPayerClaimAdjustmentIndicator":"SAMPLE_TEXT"
                , "otherPayerClaimControlNumber":"SAMPLE_TEXT"
                , "payerPaidAmount":"0"
                , "paymentResponsibilityLevelCode":"SAMPLE_TEXT"
                , "individualRelationshipCode":"SAMPLE_TEXT"
                , "claimFilingIndicatorCode":"SAMPLE_TEXT"
                , "otherPayerBenefitsAssignmentCertificationIndicator":"SAMPLE_TEXT"
                , "releaseOfInformationCode":"SAMPLE_TEXT"
                , "remainingPatientLiability":"0"
                , "patientSignatureGeneratedForPatient":"SAMPLE_TEXT"
                , "updatedById":"0"
                , "updatedByName":"SAMPLE_TEXT"
                , "updatedDate":"2020-01-01T00:00:00.000Z"
                , "changeHealthPrimarySubmisionMasterId":"0"
                ...
                , "tradingPartnerCity":"SAMPLE_TEXT"
                , "tradingPartnerState":"SAMPLE_TEXT"
                , "tradingPartnerZip":"SAMPLE_TEXT"
                , "diagnosisCodeType":"SAMPLE_TEXT"
                , "secondaryClaimSubmisionMasterUuid":null
                }""")).asJson
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_secondaryClaimSubmisionMaster_url"))).exitHereIfFailed
            .pause(10)
            .repeat(5) {
                exec(http("Get created secondaryClaimSubmisionMaster")
                .get("/services/salesorder${new_secondaryClaimSubmisionMaster_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created secondaryClaimSubmisionMaster")
            .delete("/services/salesorder${new_secondaryClaimSubmisionMaster_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
