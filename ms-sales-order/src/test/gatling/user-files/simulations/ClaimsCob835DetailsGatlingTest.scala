...
class ClaimsCob835DetailsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the ClaimsCob835Details entity")
        ...
        .repeat(2) {
            ...
            .get("/services/salesorder/api/claims-cob-835-details")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new claimsCob835Details")
            .post("/services/salesorder/api/claims-cob-835-details")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
            ...
            .repeat(5) {
                ...
                .get("/services/salesorder${new_claimsCob835Details_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created claimsCob835Details")
            .delete("/services/salesorder${new_claimsCob835Details_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
