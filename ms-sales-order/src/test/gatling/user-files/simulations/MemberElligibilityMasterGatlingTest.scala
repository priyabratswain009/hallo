...
class MemberElligibilityMasterGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the MemberElligibilityMaster entity")
        ...
        .repeat(2) {
            ...
            .get("/services/salesorder/api/member-elligibility-masters")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new memberElligibilityMaster")
            .post("/services/salesorder/api/member-elligibility-masters")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "salesOrderId":"0"
            ...
            .repeat(5) {
                ...
                .get("/services/salesorder${new_memberElligibilityMaster_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created memberElligibilityMaster")
            .delete("/services/salesorder${new_memberElligibilityMaster_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
