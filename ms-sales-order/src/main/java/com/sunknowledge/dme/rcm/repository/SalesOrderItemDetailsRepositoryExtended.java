...
public interface SalesOrderItemDetailsRepositoryExtended extends SalesOrderItemDetailsRepository {
    ...
    Mono<SoItemDetailsAndClinicalAndInsuranceResponseData> findSoItemDetailsAndClinicalAndInsuranceDataBySoId(@Param("soId") Long soId, @Param("status") String status);
    ...
    Mono<ResultDropshipDTO> getSavedPurchaseOrder(@Param("salesOrderId") Long salesOrderId, @Param("vendorId") Long vendorId,
                                                  @Param("salesOrderDetailsItemId") Long salesOrderDetailsItemId,
    ...
    Mono<String> soItemInventoryTransactionUpdate(@Param("salesOrderNo") String salesOrderNo, @Param("saleType") String saleType,
                                                  @Param("itemId") Long itemId,
                                                  @Param("itemNo") String itemNo, @Param("itemName") String itemName,
                                                  @Param("itemUom") String itemUom, @Param("itemQty") Long itemQty,
                                                  @Param("wheatherSerialized") String wheatherSerialized, @Param("serialNo") String serialNo,
                                                  @Param("wheatherAssetTagged") String wheatherAssetTagged,
                                                  @Param("originalDos") LocalDate originalDos, @Param("branchId") Long branchId,
                                                  ...
                                                  @Param("createdDate") LocalDate createdDate, @Param("updatedById") Long updatedById,
                                                  @Param("updatedDate") LocalDate updatedDate, @Param("updatedByName") String updatedByName);
    ...
    Mono<ParMaster> linkParForSO(@Param("insuranceid") Long insuranceid, @Param("insurancename") String insurancename,
                                 ...
                                 @Param("patientgender") String patientgender, @Param("itemid") Long itemid,
                                 @Param("itemno") String itemno, @Param("itemname") String itemname,
                                 @Param("itemquantity") Long itemquantity, @Param("itemuom") String itemuom,
                                 @Param("description") String description, @Param("createdbyid") Long createdbyid,
                                 @Param("createdbyname") String createdbyname, @Param("dos") LocalDate dos,
                                 @Param("hcpcsno") String hcpcsno, @Param("payerlevel") String payerlevel,
                                 @Param("useexistingpar") String useexistingpar, @Param("soid") Long soid,
                                 @Param("sono") String sono, @Param("pricetableid") Long pricetableid);
    ...
    Mono<String> soDropshipItemInventoryTransactionUpdate(@Param("salesOrderNo") String salesOrderNo, @Param("saleType") String saleType,
                                                          @Param("itemId") Long itemId,
                                                          @Param("itemNo") String itemNo, @Param("itemName") String itemName,
                                                          @Param("itemUom") String itemUom, @Param("itemQty") Long itemQty,
                                                          @Param("wheatherSerialized") String wheatherSerialized, @Param("serialNo") String serialNo,
                                                          ...
                                                          @Param("createdDate") LocalDate createdDate, @Param("updatedById") Long updatedById,
                                                          @Param("updatedDate") LocalDate updatedDate, @Param("updatedByName") String updatedByName,
                                                          @Param("poNo") String poNo, @Param("isDropship") String isDropship);

    @Query(value = "SELECT * from so.d_link_par_from_so(:parId, :salesOrderId, :salesOrderDetailsItemId, :updatedById, :updatedByName)")
    Mono<Boolean> getDLinkParForItems(@Param("parId") Long parId,
                                      @Param("salesOrderId") Long salesOrderId,
                                      @Param("salesOrderDetailsItemId") String salesOrderDetailsItemId,
    ...
    Mono<Boolean> getDLinkForCmnItems(@Param("cmnId") Long cmnId,
                                      @Param("salesOrderId") Long salesOrderId,
                                      @Param("salesOrderDetailsItemId") String salesOrderDetailsItemId,
                                      @Param("updatedById") Long updatedById,
                                      @Param("updatedByName") String updatedByName);
    ...
    Mono<Boolean> getLinkForParItems(@Param("parId") Long parId,
                                     @Param("salesOrderId") Long salesOrderId,
                                     @Param("salesOrderDetailsItemId") String salesOrderDetailsItemId,
                                     @Param("updatedById") Long updatedById,
                                     @Param("updatedByName") String updatedByName);
    ...
    Mono<Boolean> getLinkForCmnItems(@Param("cmnId") Long cmnId,
                                     @Param("salesOrderId") Long salesOrderId,
                                     @Param("salesOrderDetailsItemId") String salesOrderDetailsItemId,
                                     @Param("updatedById") Long updatedById,
                                     @Param("updatedByName") String updatedByName);
