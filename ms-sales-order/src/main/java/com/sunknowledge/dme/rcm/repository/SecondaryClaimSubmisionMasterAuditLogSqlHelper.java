...
public class SecondaryClaimSubmisionMasterAuditLogSqlHelper {

    public static List<Expression> getColumns(Table table, String columnPrefix) {
        List<Expression> columns = new ArrayList<>();
        columns.add(Column.aliased("chg_health_sconary_submn_mster_id", table, columnPrefix + "_chg_health_sconary_submn_mster_id"));
