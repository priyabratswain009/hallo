...
public class PickupExchangeItems implements Serializable {
    ...
    @Id
    @Column("pickup_exchange_item_id")
    ...
    @Column("pickup_exchange_item_uuid")
    ...
    public PickupExchangeItems quantity(Double quantity) {
