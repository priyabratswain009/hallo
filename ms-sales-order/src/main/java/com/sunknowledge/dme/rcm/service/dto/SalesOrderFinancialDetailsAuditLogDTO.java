...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.SalesOrderFinancialDetailsAuditLog} entity.
 */
public class SalesOrderFinancialDetailsAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SalesOrderFinancialDetailsAuditLogDTO)) {
            return false;
        }

        SalesOrderFinancialDetailsAuditLogDTO salesOrderFinancialDetailsAuditLogDTO = (SalesOrderFinancialDetailsAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, salesOrderFinancialDetailsAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "SalesOrderFinancialDetailsAuditLogDTO{" +
