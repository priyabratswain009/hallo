...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.PrimaryClaimResubmisionMaster} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PrimaryClaimResubmisionMasterDTO implements Serializable {
    ...
    public UUID getPrimaryClaimResubmisionMasterUuid() {
        return primaryClaimResubmisionMasterUuid;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrimaryClaimResubmisionMasterDTO)) {
            return false;
        }

        PrimaryClaimResubmisionMasterDTO primaryClaimResubmisionMasterDTO = (PrimaryClaimResubmisionMasterDTO) o;
        if (this.changeHealthPrimaryResubmisionMasterId == null) {
            return false;
        }
        return Objects.equals(
            this.changeHealthPrimaryResubmisionMasterId,
            primaryClaimResubmisionMasterDTO.changeHealthPrimaryResubmisionMasterId
        );
    }
    ...
    public String toString() {
        return "PrimaryClaimResubmisionMasterDTO{" +
