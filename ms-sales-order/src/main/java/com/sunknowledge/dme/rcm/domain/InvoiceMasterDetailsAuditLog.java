...
/**
 * A InvoiceMasterDetailsAuditLog.
 */
@Table("t_invoice_master_details_audit_log")
public class InvoiceMasterDetailsAuditLog implements Serializable {
    ...
    public InvoiceMasterDetailsAuditLog invceId(Long invceId) {
        this.setInvceId(invceId);
        return this;
    }
    ...
    public InvoiceMasterDetailsAuditLog oldRowData(String oldRowData) {
    ...
    public InvoiceMasterDetailsAuditLog newRowData(String newRowData) {
    ...
    public InvoiceMasterDetailsAuditLog dmlType(String dmlType) {
    ...
    public InvoiceMasterDetailsAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public InvoiceMasterDetailsAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public InvoiceMasterDetailsAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InvoiceMasterDetailsAuditLog)) {
            return false;
        }
        return invceId != null && invceId.equals(((InvoiceMasterDetailsAuditLog) o).invceId);
    }
