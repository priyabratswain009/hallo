...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.PrimaryClaimSubmisionMaster} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PrimaryClaimSubmisionMasterDTO implements Serializable {
    ...
    public UUID getPrimaryClaimSubmisionMasterUuid() {
        return primaryClaimSubmisionMasterUuid;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PrimaryClaimSubmisionMasterDTO)) {
            return false;
        }

        PrimaryClaimSubmisionMasterDTO primaryClaimSubmisionMasterDTO = (PrimaryClaimSubmisionMasterDTO) o;
        if (this.changeHealthPrimarySubmisionMasterId == null) {
            return false;
        }
        return Objects.equals(
            this.changeHealthPrimarySubmisionMasterId,
            primaryClaimSubmisionMasterDTO.changeHealthPrimarySubmisionMasterId
        );
    }

    @Override
    public int hashCode() {
        return Objects.hash(this.changeHealthPrimarySubmisionMasterId);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "PrimaryClaimSubmisionMasterDTO{" +
