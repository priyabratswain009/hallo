...
/**
 * Converter between {@link Row} to {@link PrimaryClaimResubmisionMaster}, with proper type conversions.
 */
@Service
public class PrimaryClaimResubmisionMasterRowMapper implements BiFunction<Row, String, PrimaryClaimResubmisionMaster> {

    private final ColumnConverter converter;

    public PrimaryClaimResubmisionMasterRowMapper(ColumnConverter converter) {
        this.converter = converter;
    }

    /**
     * Take a {@link Row} and a column prefix, and extract all the fields.
     * @return the {@link PrimaryClaimResubmisionMaster} stored in the database.
     */
    @Override
    public PrimaryClaimResubmisionMaster apply(Row row, String prefix) {
        PrimaryClaimResubmisionMaster entity = new PrimaryClaimResubmisionMaster();
        ...
        entity.setPrimaryClaimResubmisionMasterUuid(converter.fromRow(row, prefix + "_primary_claim_resubmision_master_uuid", UUID.class));
        return entity;
    }
}
