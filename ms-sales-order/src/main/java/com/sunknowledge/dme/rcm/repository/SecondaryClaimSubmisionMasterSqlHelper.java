...
public class SecondaryClaimSubmisionMasterSqlHelper {

    public static List<Expression> getColumns(Table table, String columnPrefix) {
        List<Expression> columns = new ArrayList<>();
        columns.add(
            Column.aliased(
                "change_health_secondary_submision_master_id",
                table,
                columnPrefix + "_change_health_secondary_submision_master_id"
            )
        );
        ...
        columns.add(Column.aliased("other_subscriber_address_1", table, columnPrefix + "_other_subscriber_address_1"));
        columns.add(Column.aliased("other_subscriber_address_2", table, columnPrefix + "_other_subscriber_address_2"));
        columns.add(Column.aliased("other_subscriber_city", table, columnPrefix + "_other_subscriber_city"));
        columns.add(Column.aliased("other_subscriber_state", table, columnPrefix + "_other_subscriber_state"));
        columns.add(Column.aliased("other_subscriber_zip", table, columnPrefix + "_other_subscriber_zip"));
        columns.add(Column.aliased("other_insured_qualifier", table, columnPrefix + "_other_insured_qualifier"));
        columns.add(Column.aliased("other_insured_last_name", table, columnPrefix + "_other_insured_last_name"));
        columns.add(Column.aliased("other_insured_first_name", table, columnPrefix + "_other_insured_first_name"));
        columns.add(Column.aliased("other_insured_identifier_type_code", table, columnPrefix + "_other_insured_identifier_type_code"));
        columns.add(Column.aliased("other_insured_identifier", table, columnPrefix + "_other_insured_identifier"));
        columns.add(Column.aliased("other_payer_organization_name", table, columnPrefix + "_other_payer_organization_name"));
        columns.add(Column.aliased("other_payer_identifier_type_code", table, columnPrefix + "_other_payer_identifier_type_code"));
        columns.add(Column.aliased("other_payer_identifier", table, columnPrefix + "_other_payer_identifier"));
        columns.add(
            Column.aliased("other_payer_adjudication_or_payment_date", table, columnPrefix + "_other_payer_adjudication_or_payment_date")
        );
        columns.add(
            Column.aliased("other_payer_claim_adjustment_indicator", table, columnPrefix + "_other_payer_claim_adjustment_indicator")
        );
        columns.add(Column.aliased("other_payer_claim_control_number", table, columnPrefix + "_other_payer_claim_control_number"));
        columns.add(Column.aliased("payer_paid_amount", table, columnPrefix + "_payer_paid_amount"));
        columns.add(Column.aliased("payment_responsibility_level_code", table, columnPrefix + "_payment_responsibility_level_code"));
        columns.add(Column.aliased("individual_relationship_code", table, columnPrefix + "_individual_relationship_code"));
        columns.add(Column.aliased("claim_filing_indicator_code", table, columnPrefix + "_claim_filing_indicator_code"));
        columns.add(
            Column.aliased(
                "other_payer_benefits_assignment_certification_indicator",
                table,
                columnPrefix + "_other_payer_benefits_assignment_certification_indicator"
            )
        );
        columns.add(Column.aliased("release_of_information_code", table, columnPrefix + "_release_of_information_code"));
        columns.add(Column.aliased("remaining_patient_liability", table, columnPrefix + "_remaining_patient_liability"));
        columns.add(
            Column.aliased("patient_signature_generated_for_patient", table, columnPrefix + "_patient_signature_generated_for_patient")
        );
        ...
        columns.add(Column.aliased("trading_partner_city", table, columnPrefix + "_trading_partner_city"));
        ...
        columns.add(
            Column.aliased("secondary_claim_submision_master_uuid", table, columnPrefix + "_secondary_claim_submision_master_uuid")
        );
