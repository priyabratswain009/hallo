...
public class PrimaryClaimResubmisionMasterSqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(
            Column.aliased("primary_claim_resubmision_master_uuid", table, columnPrefix + "_primary_claim_resubmision_master_uuid")
        );
