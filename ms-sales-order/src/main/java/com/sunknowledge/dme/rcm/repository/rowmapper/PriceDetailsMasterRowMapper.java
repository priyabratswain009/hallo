...
/**
 * Converter between {@link Row} to {@link PriceDetailsMaster}, with proper type conversions.
 */
@Service
public class PriceDetailsMasterRowMapper implements BiFunction<Row, String, PriceDetailsMaster> {

    private final ColumnConverter converter;

    public PriceDetailsMasterRowMapper(ColumnConverter converter) {
        this.converter = converter;
    }

    /**
     * Take a {@link Row} and a column prefix, and extract all the fields.
     * @return the {@link PriceDetailsMaster} stored in the database.
     */
    @Override
    public PriceDetailsMaster apply(Row row, String prefix) {
        PriceDetailsMaster entity = new PriceDetailsMaster();
