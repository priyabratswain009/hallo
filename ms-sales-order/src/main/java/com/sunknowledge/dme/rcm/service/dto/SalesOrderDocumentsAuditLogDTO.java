...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.SalesOrderDocumentsAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SalesOrderDocumentsAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SalesOrderDocumentsAuditLogDTO)) {
            return false;
        }

        SalesOrderDocumentsAuditLogDTO salesOrderDocumentsAuditLogDTO = (SalesOrderDocumentsAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, salesOrderDocumentsAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "SalesOrderDocumentsAuditLogDTO{" +
