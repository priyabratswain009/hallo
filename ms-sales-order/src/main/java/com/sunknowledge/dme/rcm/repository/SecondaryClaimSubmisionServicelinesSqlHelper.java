...
public class SecondaryClaimSubmisionServicelinesSqlHelper {

    public static List<Expression> getColumns(Table table, String columnPrefix) {
        List<Expression> columns = new ArrayList<>();
        columns.add(
            Column.aliased(
                "change_health_secondary_submision_servicelines_id",
                table,
                columnPrefix + "_change_health_secondary_submision_servicelines_id"
            )
        );
        columns.add(
            Column.aliased(
        ...
        columns.add(Column.aliased("line_adjustment", table, columnPrefix + "_line_adjustment"));
        ...
        columns.add(
            Column.aliased(
                "secondary_claim_submision_servicelines_uuid",
                table,
                columnPrefix + "_secondary_claim_submision_servicelines_uuid"
            )
        );
