...
/**
 * Converter between {@link Row} to {@link ElligibilityResponse}, with proper type conversions.
 */
@Service
public class ElligibilityResponseRowMapper implements BiFunction<Row, String, ElligibilityResponse> {

    private final ColumnConverter converter;

    public ElligibilityResponseRowMapper(ColumnConverter converter) {
        this.converter = converter;
    }

    /**
     * Take a {@link Row} and a column prefix, and extract all the fields.
     * @return the {@link ElligibilityResponse} stored in the database.
     */
    @Override
    public ElligibilityResponse apply(Row row, String prefix) {
        ElligibilityResponse entity = new ElligibilityResponse();
