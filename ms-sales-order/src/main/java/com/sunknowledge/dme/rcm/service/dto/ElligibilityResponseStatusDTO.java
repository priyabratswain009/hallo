...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.ElligibilityResponseStatus} entity.
 */
public class ElligibilityResponseStatusDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ElligibilityResponseStatusDTO)) {
            return false;
        }

        ElligibilityResponseStatusDTO elligibilityResponseStatusDTO = (ElligibilityResponseStatusDTO) o;
        if (this.elligibilityResponseStatusId == null) {
            return false;
        }
        return Objects.equals(this.elligibilityResponseStatusId, elligibilityResponseStatusDTO.elligibilityResponseStatusId);
    }
    ...
    public String toString() {
        return "ElligibilityResponseStatusDTO{" +
