...
public class SalesOrderClinicalDetailsAuditLogSqlHelper {

    public static List<Expression> getColumns(Table table, String columnPrefix) {
        List<Expression> columns = new ArrayList<>();
        columns.add(Column.aliased("sals_odr_clincal_detils_id", table, columnPrefix + "_sals_odr_clincal_detils_id"));
