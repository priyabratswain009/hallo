...
public class PrimaryClaimSubmisionServicelinesSqlHelper {

    public static List<Expression> getColumns(Table table, String columnPrefix) {
        List<Expression> columns = new ArrayList<>();
        columns.add(
            Column.aliased(
                "change_health_primary_submision_servicelines_id",
                table,
                columnPrefix + "_change_health_primary_submision_servicelines_id"
            )
        );
        columns.add(
        ...
        columns.add(
            Column.aliased("primary_claim_submision_servicelines_uuid", table, columnPrefix + "_primary_claim_submision_servicelines_uuid")
        );
