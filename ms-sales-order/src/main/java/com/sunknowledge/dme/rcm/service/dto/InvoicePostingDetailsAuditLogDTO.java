...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.InvoicePostingDetailsAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InvoicePostingDetailsAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InvoicePostingDetailsAuditLogDTO)) {
            return false;
        }

        InvoicePostingDetailsAuditLogDTO invoicePostingDetailsAuditLogDTO = (InvoicePostingDetailsAuditLogDTO) o;
        if (this.invLineItmPstingId == null) {
            return false;
        }
        return Objects.equals(this.invLineItmPstingId, invoicePostingDetailsAuditLogDTO.invLineItmPstingId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(this.invLineItmPstingId);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "InvoicePostingDetailsAuditLogDTO{" +
