...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.SecondaryClaimSubmisionMasterAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SecondaryClaimSubmisionMasterAuditLogDTO implements Serializable {
    ...
    public Long getChgHealthSconarySubmnMsterId() {
        return chgHealthSconarySubmnMsterId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SecondaryClaimSubmisionMasterAuditLogDTO)) {
            return false;
        }

        SecondaryClaimSubmisionMasterAuditLogDTO secondaryClaimSubmisionMasterAuditLogDTO = (SecondaryClaimSubmisionMasterAuditLogDTO) o;
        if (this.chgHealthSconarySubmnMsterId == null) {
            return false;
        }
        return Objects.equals(this.chgHealthSconarySubmnMsterId, secondaryClaimSubmisionMasterAuditLogDTO.chgHealthSconarySubmnMsterId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(this.chgHealthSconarySubmnMsterId);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "SecondaryClaimSubmisionMasterAuditLogDTO{" +
