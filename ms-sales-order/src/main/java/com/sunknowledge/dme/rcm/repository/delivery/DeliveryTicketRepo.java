...
import com.sunknowledge.dme.rcm.service.dto.delivery.CreateDeliveryTicketOutcome;
...
public interface DeliveryTicketRepo extends DeliveryTicketRepository {
    ...
    @Query(value = "select deliveryticketid, deliveryticketno, salesorderid, salesorderno, inventorylocationid, deliverytypee, deliveryticketuuid from createdeliveryticket(:soidd, :deliverytype, :setupmethod, :uid, :uname, :createddate)")
    Flux<CreateDeliveryTicketOutcome> callToCreateDeliveryTicket(@Param("soid") Long soid, @Param("deliverytype") String deliverytype,
                                                                 @Param("setupmethod") String setupmethod, @Param("uid") Long uid,
                                                                 @Param("uname") String uname, @Param("createddate") String createddate);
}
