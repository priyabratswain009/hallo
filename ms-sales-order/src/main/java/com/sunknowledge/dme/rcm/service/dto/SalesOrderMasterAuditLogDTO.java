...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.SalesOrderMasterAuditLog} entity.
 */
public class SalesOrderMasterAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SalesOrderMasterAuditLogDTO)) {
            return false;
        }

        SalesOrderMasterAuditLogDTO salesOrderMasterAuditLogDTO = (SalesOrderMasterAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
