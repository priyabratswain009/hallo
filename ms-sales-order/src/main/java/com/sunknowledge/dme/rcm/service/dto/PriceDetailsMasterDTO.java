...
public class PriceDetailsMasterDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PriceDetailsMasterDTO)) {
            return false;
        }

        PriceDetailsMasterDTO priceDetailsMasterDTO = (PriceDetailsMasterDTO) o;
        if (this.priceDetailsId == null) {
            return false;
        }
        return Objects.equals(this.priceDetailsId, priceDetailsMasterDTO.priceDetailsId);
    }
