 ...
 */
@Table("t_invoice_line_item_details")
public class InvoiceLineItemDetails implements Serializable {
    ...
    @Column("invoice_line_item_details_uuid")
    ...
    @Column("patient_invoice_no")
    private String patientInvoiceNo;

    @Column("primary_invoice_id")
    private Long primaryInvoiceId;

    @Column("secondary_invoice_id")
    private Long secondaryInvoiceId;

    @Column("tertiary_invoice_id")
    private Long tertiaryInvoiceId;

    @Column("patient_invoice_id")
    ...
    public InvoiceLineItemDetails chargedAmount(Long chargedAmount) {
