...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.SalesOrderInsuranceDetailsAuditLog} entity.
 */
public class SalesOrderInsuranceDetailsAuditLogDTO implements Serializable {
    ...
    public Long getSalsOrdInsranceDetailsId() {
        return salsOrdInsranceDetailsId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SalesOrderInsuranceDetailsAuditLogDTO)) {
            return false;
        }

        SalesOrderInsuranceDetailsAuditLogDTO salesOrderInsuranceDetailsAuditLogDTO = (SalesOrderInsuranceDetailsAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, salesOrderInsuranceDetailsAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "SalesOrderInsuranceDetailsAuditLogDTO{" +
