...
class InvoiceMasterDetailsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the InvoiceMasterDetails entity")
        ...
        .repeat(2) {
            ...
            .get("/services/claims/api/invoice-master-details")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new invoiceMasterDetails")
            .post("/services/claims/api/invoice-master-details")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
            ...
            .repeat(5) {
                ...
                .get("/services/claims${new_invoiceMasterDetails_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created invoiceMasterDetails")
            .delete("/services/claims${new_invoiceMasterDetails_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
