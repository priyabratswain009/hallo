...
class InvoicePostingDetailsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the InvoicePostingDetails entity")
        ...
        .repeat(2) {
            ...
            .get("/services/claims/api/invoice-posting-details")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new invoicePostingDetails")
            .post("/services/claims/api/invoice-posting-details")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "itemId":"0"
            ...
            .repeat(5) {
                ...
                .get("/services/claims${new_invoicePostingDetails_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created invoicePostingDetails")
            .delete("/services/claims${new_invoicePostingDetails_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
