...
class InvoiceLineItemDetailsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the InvoiceLineItemDetails entity")
        ...
        .repeat(2) {
            ...
            .get("/services/claims/api/invoice-line-item-details")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new invoiceLineItemDetails")
            .post("/services/claims/api/invoice-line-item-details")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
            ...
            .repeat(5) {
                ...
                .get("/services/claims${new_invoiceLineItemDetails_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created invoiceLineItemDetails")
            .delete("/services/claims${new_invoiceLineItemDetails_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
