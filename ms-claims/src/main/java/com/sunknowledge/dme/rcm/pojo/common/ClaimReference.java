...
@JsonPropertyOrder({ "correlationId", "submitterId", "customerClaimNumber", "patientControlNumber", "timeOfResponse",
		"claimType", "formatVersion", "rhclaimNumber" })
...
public class ClaimReference {
	...
	@JsonProperty("rhclaimNumber")
	private String rhclaimNumber;
	@JsonIgnore
	...
	@JsonProperty("rhclaimNumber")
	public String getRhclaimNumber() {
		return rhclaimNumber;
	}

	@JsonProperty("rhclaimNumber")
	public void setRhclaimNumber(String rhclaimNumber) {
		this.rhclaimNumber = rhclaimNumber;
	}
