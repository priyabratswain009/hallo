...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.ServiceLinesMaster} entity.
 */
public class ServiceLinesMasterDTO implements Serializable {
    ...
    private ClaimsSubmissionMasterDTO claimsSubmissionMaster;
    ...
    public ClaimsSubmissionMasterDTO getClaimsSubmissionMaster() {
        return claimsSubmissionMaster;
    }

    public void setClaimsSubmissionMaster(ClaimsSubmissionMasterDTO claimsSubmissionMaster) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ServiceLinesMasterDTO)) {
            return false;
        }

        ServiceLinesMasterDTO serviceLinesMasterDTO = (ServiceLinesMasterDTO) o;
        if (this.changeHealthPrimarySubmisionServicelinesId == null) {
            return false;
        }
        return Objects.equals(
            this.changeHealthPrimarySubmisionServicelinesId,
            serviceLinesMasterDTO.changeHealthPrimarySubmisionServicelinesId
        );
    }
    ...
    public String toString() {
        return "ServiceLinesMasterDTO{" +
            ...
            ", claimsSubmissionMaster=" + getClaimsSubmissionMaster() +
            "}";
    }
}
