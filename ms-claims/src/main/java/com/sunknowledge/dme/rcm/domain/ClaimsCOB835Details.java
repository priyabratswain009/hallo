 ...
 */
@Entity
@Table(name = "t_claims_cob_835_details")
public class ClaimsCOB835Details implements Serializable {
    ...
    @Column(name = "claim_cob_835_detail_id", nullable = false)
    private Long claimCob835DetailId;

    @Column(name = "service_date")
    private LocalDate serviceDate;

    @Column(name = "adjudicated_procedure_code")
    private String adjudicatedProcedureCode;

    @Column(name = "adjudicated_procedure_modifier_codes")
    ...
    @Column(name = "adjustment_pr_code_1")
    private String adjustmentPrCode1;

    @Column(name = "adjustment_pr_code_1_amount")
    private Double adjustmentPrCode1Amount;

    @Column(name = "adjustment_pr_code_2")
    private String adjustmentPrCode2;

    @Column(name = "adjustment_pr_code_2_amount")
    private Double adjustmentPrCode2Amount;

    @Column(name = "adjustment_pr_code_3")
    private String adjustmentPrCode3;

    @Column(name = "adjustment_pr_code_3_amount")
    private Double adjustmentPrCode3Amount;

    @Column(name = "adjustment_pr_code_4")
    private String adjustmentPrCode4;

    @Column(name = "adjustment_pr_code_4_amount")
    private Double adjustmentPrCode4Amount;

    @Column(name = "adjustment_co_code_1")
    private String adjustmentCoCode1;

    @Column(name = "adjustment_co_code_1_amount")
    private Double adjustmentCoCode1Amount;

    @Column(name = "adjustment_co_code_2")
    private String adjustmentCoCode2;

    @Column(name = "adjustment_co_code_2_amount")
    private Double adjustmentCoCode2Amount;

    @Column(name = "adjustment_co_code_3")
    private String adjustmentCoCode3;

    @Column(name = "adjustment_co_code_3_amount")
    private Double adjustmentCoCode3Amount;

    @Column(name = "adjustment_co_code_4")
    private String adjustmentCoCode4;

    @Column(name = "adjustment_co_code_4_amount")
    private Double adjustmentCoCode4Amount;

    @Column(name = "adjustment_cr_code_1")
    private String adjustmentCrCode1;

    @Column(name = "adjustment_cr_code_1_amount")
    private Double adjustmentCrCode1Amount;

    @Column(name = "adjustment_cr_code_2")
    private String adjustmentCrCode2;

    @Column(name = "adjustment_cr_code_2_amount")
    private Double adjustmentCrCode2Amount;

    @Column(name = "adjustment_cr_code_3")
    private String adjustmentCrCode3;

    @Column(name = "adjustment_cr_code_3_amount")
    private Double adjustmentCrCode3Amount;

    @Column(name = "adjustment_cr_code_4")
    private String adjustmentCrCode4;

    @Column(name = "adjustment_cr_code_4_amount")
    private Double adjustmentCrCode4Amount;

    @Column(name = "adjustment_oa_code_1")
    private String adjustmentOaCode1;

    @Column(name = "adjustment_oa_code_1_amount")
    private Double adjustmentOaCode1Amount;

    @Column(name = "adjustment_oa_code_2")
    private String adjustmentOaCode2;

    @Column(name = "adjustment_oa_code_2_amount")
    private Double adjustmentOaCode2Amount;

    @Column(name = "adjustment_oa_code_3")
    private String adjustmentOaCode3;

    @Column(name = "adjustment_oa_code_3_amount")
    private Double adjustmentOaCode3Amount;

    @Column(name = "adjustment_oa_code_4")
    private String adjustmentOaCode4;

    @Column(name = "adjustment_oa_code_4_amount")
    private Double adjustmentOaCode4Amount;

    @Column(name = "adjustment_pi_code_1")
    private String adjustmentPiCode1;

    @Column(name = "adjustment_pi_code_1_amount")
    private Double adjustmentPiCode1Amount;

    @Column(name = "adjustment_pi_code_2")
    private String adjustmentPiCode2;

    @Column(name = "adjustment_pi_code_2_amount")
    private Double adjustmentPiCode2Amount;

    @Column(name = "adjustment_pi_code_3")
    private String adjustmentPiCode3;

    @Column(name = "adjustment_pi_code_3_amount")
    private Double adjustmentPiCode3Amount;

    @Column(name = "adjustment_pi_code_4")
    private String adjustmentPiCode4;

    @Column(name = "adjustment_pi_code_4_amount")
    private Double adjustmentPiCode4Amount;

    @Column(name = "provider_payment_amount")
    ...
    @Column(name = "claims_cob_835_details_uuid")
    ...
    public ClaimsCOB835Details unitCount(Integer unitCount) {
    ...
    public ClaimsCOB835Details postStatus(String postStatus) {
