...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.ClaimsSubmissionMaster} entity.
 */
public class ClaimsSubmissionMasterDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClaimsSubmissionMasterDTO)) {
            return false;
        }

        ClaimsSubmissionMasterDTO claimsSubmissionMasterDTO = (ClaimsSubmissionMasterDTO) o;
        if (this.changeHealthPrimarySubmisionMasterId == null) {
            return false;
        }
        return Objects.equals(this.changeHealthPrimarySubmisionMasterId, claimsSubmissionMasterDTO.changeHealthPrimarySubmisionMasterId);
    }
    ...
    public String toString() {
        return "ClaimsSubmissionMasterDTO{" +
