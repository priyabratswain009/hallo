...
/**
 * A ItemInventoryStatusAuditLog.
 */
@Entity
@Table(name = "t_item_inventory_status_audit_log")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ItemInventoryStatusAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "item_invtory_staus_id")
    ...
    public Long getItemInvtoryStausId() {
        return this.itemInvtoryStausId;
    }

    public ItemInventoryStatusAuditLog itemInvtoryStausId(Long itemInvtoryStausId) {
        this.setItemInvtoryStausId(itemInvtoryStausId);
        return this;
    }

    public void setItemInvtoryStausId(Long itemInvtoryStausId) {
        this.itemInvtoryStausId = itemInvtoryStausId;
    }
    ...
    public ItemInventoryStatusAuditLog oldRowData(String oldRowData) {
    ...
    public ItemInventoryStatusAuditLog newRowData(String newRowData) {
    ...
    public ItemInventoryStatusAuditLog dmlType(String dmlType) {
    ...
    public ItemInventoryStatusAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public ItemInventoryStatusAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public ItemInventoryStatusAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ItemInventoryStatusAuditLog)) {
            return false;
        }
        return id != null && id.equals(((ItemInventoryStatusAuditLog) o).id);
    }
    ...
    public String toString() {
        return "ItemInventoryStatusAuditLog{" +
            "id=" + getId() +
            ", itemInvtoryStausId=" + getItemInvtoryStausId() +
