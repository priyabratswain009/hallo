...
/**
 * A ItemVendorMappingAuditLog.
 */
@Entity
@Table(name = "t_item_vendor_mapping_audit_log")
public class ItemVendorMappingAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "itm_vndor_id")
    private Long itmVndorId;
    ...
    public Long getItmVndorId() {
        return this.itmVndorId;
    }

    public ItemVendorMappingAuditLog itmVndorId(Long itmVndorId) {
        this.setItmVndorId(itmVndorId);
        return this;
    }

    public void setItmVndorId(Long itmVndorId) {
        this.itmVndorId = itmVndorId;
    }
    ...
    public ItemVendorMappingAuditLog oldRowData(String oldRowData) {
    ...
    public ItemVendorMappingAuditLog newRowData(String newRowData) {
    ...
    public ItemVendorMappingAuditLog dmlType(String dmlType) {
    ...
    public ItemVendorMappingAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public ItemVendorMappingAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public ItemVendorMappingAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ItemVendorMappingAuditLog)) {
            return false;
        }
        return id != null && id.equals(((ItemVendorMappingAuditLog) o).id);
    }
