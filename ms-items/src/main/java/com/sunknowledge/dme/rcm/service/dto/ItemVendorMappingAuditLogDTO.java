...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.ItemVendorMappingAuditLog} entity.
 */
public class ItemVendorMappingAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ItemVendorMappingAuditLogDTO)) {
            return false;
        }

        ItemVendorMappingAuditLogDTO itemVendorMappingAuditLogDTO = (ItemVendorMappingAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, itemVendorMappingAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "ItemVendorMappingAuditLogDTO{" +
