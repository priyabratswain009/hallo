...
@AllArgsConstructor
@NoArgsConstructor
public class PurchaseOrderParameterDTO {
    ...
    @NotNull(message="Billing_Contact_Email must be provided.")
    @NotBlank(message="Billing_Contact_Email must be provided.")
    ...
    @NotNull(message="Delivery_Contact_Email must be provided.")
    @NotBlank(message="Delivery_Contact_Email must be provided.")
    @Pattern(regexp = RegexConstant.EMAIL_REGEX,
        message = "Provide only appropriate Email")
    String deliveryContactEmail;
    @NotNull(message="Purchase_Order_Items must be selected.")
    @NotBlank(message="Purchase_Order_Items must be selected.")
    String itemIds;
    @NotNull(message="Purchase_Order_Item_Quantities must be provided.")
    @NotBlank(message="Purchase_Order_Item_Quantities must be provided.")
    String itemQtys;
