...
public class StockTransferAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StockTransferAuditLogDTO)) {
            return false;
        }

        StockTransferAuditLogDTO stockTransferAuditLogDTO = (StockTransferAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, stockTransferAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "StockTransferAuditLogDTO{" +
