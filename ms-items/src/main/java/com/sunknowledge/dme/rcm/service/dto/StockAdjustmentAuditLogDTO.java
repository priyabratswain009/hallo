...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.StockAdjustmentAuditLog} entity.
 */
public class StockAdjustmentAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StockAdjustmentAuditLogDTO)) {
            return false;
        }

        StockAdjustmentAuditLogDTO stockAdjustmentAuditLogDTO = (StockAdjustmentAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, stockAdjustmentAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "StockAdjustmentAuditLogDTO{" +
