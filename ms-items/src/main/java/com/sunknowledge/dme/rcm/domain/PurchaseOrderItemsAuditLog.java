...
/**
 * A PurchaseOrderItemsAuditLog.
 */
@Entity
@Table(name = "t_purchase_order_items_audit_log")
public class PurchaseOrderItemsAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "po_itms_id")
    private Long poItmsId;
    ...
    public Long getPoItmsId() {
        return this.poItmsId;
    }

    public PurchaseOrderItemsAuditLog poItmsId(Long poItmsId) {
        this.setPoItmsId(poItmsId);
        return this;
    }

    public void setPoItmsId(Long poItmsId) {
        this.poItmsId = poItmsId;
    }
    ...
    public PurchaseOrderItemsAuditLog oldRowData(String oldRowData) {
    ...
    public PurchaseOrderItemsAuditLog newRowData(String newRowData) {
    ...
    public PurchaseOrderItemsAuditLog dmlType(String dmlType) {
    ...
    public PurchaseOrderItemsAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public PurchaseOrderItemsAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public PurchaseOrderItemsAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PurchaseOrderItemsAuditLog)) {
            return false;
        }
        return id != null && id.equals(((PurchaseOrderItemsAuditLog) o).id);
    }
