...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.PurchaseOrderItemsAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PurchaseOrderItemsAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PurchaseOrderItemsAuditLogDTO)) {
            return false;
        }

        PurchaseOrderItemsAuditLogDTO purchaseOrderItemsAuditLogDTO = (PurchaseOrderItemsAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, purchaseOrderItemsAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "PurchaseOrderItemsAuditLogDTO{" +
