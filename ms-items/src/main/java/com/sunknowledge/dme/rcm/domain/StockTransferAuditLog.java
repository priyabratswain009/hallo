...
/**
 * A StockTransferAuditLog.
 */
@Entity
@Table(name = "t_stock_transfer_audit_log")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class StockTransferAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "stck_trasfer_id")
    ...
    public Long getStckTrasferId() {
        return this.stckTrasferId;
    }

    public StockTransferAuditLog stckTrasferId(Long stckTrasferId) {
        this.setStckTrasferId(stckTrasferId);
        return this;
    }

    public void setStckTrasferId(Long stckTrasferId) {
        this.stckTrasferId = stckTrasferId;
    }
    ...
    public StockTransferAuditLog oldRowData(String oldRowData) {
    ...
    public StockTransferAuditLog newRowData(String newRowData) {
    ...
    public StockTransferAuditLog dmlType(String dmlType) {
    ...
    public StockTransferAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public StockTransferAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public StockTransferAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StockTransferAuditLog)) {
            return false;
        }
        return id != null && id.equals(((StockTransferAuditLog) o).id);
    }
    ...
    public String toString() {
        return "StockTransferAuditLog{" +
            "id=" + getId() +
            ", stckTrasferId=" + getStckTrasferId() +
