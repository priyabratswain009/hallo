...
/**
 * A PriceDetailsAuditLog.
 */
@Entity
@Table(name = "t_price_details_audit_log")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PriceDetailsAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "prce_detl_id")
    private Long prceDetlId;
    ...
    public Long getPrceDetlId() {
        return this.prceDetlId;
    }

    public PriceDetailsAuditLog prceDetlId(Long prceDetlId) {
        this.setPrceDetlId(prceDetlId);
        return this;
    }

    public void setPrceDetlId(Long prceDetlId) {
        this.prceDetlId = prceDetlId;
    }
    ...
    public PriceDetailsAuditLog oldRowData(String oldRowData) {
    ...
    public PriceDetailsAuditLog newRowData(String newRowData) {
    ...
    public PriceDetailsAuditLog dmlType(String dmlType) {
    ...
    public PriceDetailsAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public PriceDetailsAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public PriceDetailsAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PriceDetailsAuditLog)) {
            return false;
        }
        return id != null && id.equals(((PriceDetailsAuditLog) o).id);
    }
