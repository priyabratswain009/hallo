...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.ItemTypeAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ItemTypeAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ItemTypeAuditLogDTO)) {
            return false;
        }

        ItemTypeAuditLogDTO itemTypeAuditLogDTO = (ItemTypeAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, itemTypeAuditLogDTO.id);
    }
