...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.ManufacturerAuditLog} entity.
 */
public class ManufacturerAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManufacturerAuditLogDTO)) {
            return false;
        }

        ManufacturerAuditLogDTO manufacturerAuditLogDTO = (ManufacturerAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, manufacturerAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "ManufacturerAuditLogDTO{" +
