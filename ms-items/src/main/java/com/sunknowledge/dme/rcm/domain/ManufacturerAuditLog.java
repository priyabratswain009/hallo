...
/**
 * A ManufacturerAuditLog.
 */
@Entity
@Table(name = "t_manufacturer_audit_log")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ManufacturerAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "mnufcturer_id")
    private Long mnufcturerId;
    ...
    public Long getMnufcturerId() {
        return this.mnufcturerId;
    }

    public ManufacturerAuditLog mnufcturerId(Long mnufcturerId) {
        this.setMnufcturerId(mnufcturerId);
        return this;
    }

    public void setMnufcturerId(Long mnufcturerId) {
        this.mnufcturerId = mnufcturerId;
    }
    ...
    public ManufacturerAuditLog oldRowData(String oldRowData) {
    ...
    public ManufacturerAuditLog newRowData(String newRowData) {
    ...
    public ManufacturerAuditLog dmlType(String dmlType) {
    ...
    public ManufacturerAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public ManufacturerAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public ManufacturerAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManufacturerAuditLog)) {
            return false;
        }
        return id != null && id.equals(((ManufacturerAuditLog) o).id);
    }
