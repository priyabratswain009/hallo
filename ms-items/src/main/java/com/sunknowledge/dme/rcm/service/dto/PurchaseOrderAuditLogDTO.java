...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.PurchaseOrderAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PurchaseOrderAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PurchaseOrderAuditLogDTO)) {
            return false;
        }

        PurchaseOrderAuditLogDTO purchaseOrderAuditLogDTO = (PurchaseOrderAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, purchaseOrderAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "PurchaseOrderAuditLogDTO{" +
            "pId=" + getpId() +
