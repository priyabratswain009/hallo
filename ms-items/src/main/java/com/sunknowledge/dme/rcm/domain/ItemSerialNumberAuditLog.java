...
/**
 * A ItemSerialNumberAuditLog.
 */
@Entity
@Table(name = "t_item_serial_number_audit_log")
public class ItemSerialNumberAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "itm_srial_nmber_id")
    ...
    public Long getItmSrialNmberId() {
        return this.itmSrialNmberId;
    }

    public ItemSerialNumberAuditLog itmSrialNmberId(Long itmSrialNmberId) {
        this.setItmSrialNmberId(itmSrialNmberId);
        return this;
    }
    ...
    public ItemSerialNumberAuditLog oldRowData(String oldRowData) {
    ...
    public ItemSerialNumberAuditLog newRowData(String newRowData) {
    ...
    public ItemSerialNumberAuditLog dmlType(String dmlType) {
    ...
    public ItemSerialNumberAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public ItemSerialNumberAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public ItemSerialNumberAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ItemSerialNumberAuditLog)) {
            return false;
        }
        return id != null && id.equals(((ItemSerialNumberAuditLog) o).id);
    }
