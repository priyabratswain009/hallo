 ...
 */
@Entity
@Table(name = "t_item_group_audit_log")
public class ItemGroupAuditLog implements Serializable {
    ...
    public ItemGroupAuditLog itemGrpId(Long itemGrpId) {
        this.setItemGrpId(itemGrpId);
        return this;
    }
    ...
    public ItemGroupAuditLog oldRowData(String oldRowData) {
    ...
    public ItemGroupAuditLog newRowData(String newRowData) {
    ...
    public ItemGroupAuditLog dmlType(String dmlType) {
    ...
    public ItemGroupAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public ItemGroupAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public ItemGroupAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ItemGroupAuditLog)) {
            return false;
        }
        return id != null && id.equals(((ItemGroupAuditLog) o).id);
    }
