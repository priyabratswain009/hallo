...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.PriceMasterAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PriceMasterAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PriceMasterAuditLogDTO)) {
            return false;
        }

        PriceMasterAuditLogDTO priceMasterAuditLogDTO = (PriceMasterAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, priceMasterAuditLogDTO.id);
    }
