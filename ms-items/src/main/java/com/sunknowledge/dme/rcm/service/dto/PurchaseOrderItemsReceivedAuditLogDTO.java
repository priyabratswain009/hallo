...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.PurchaseOrderItemsReceivedAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PurchaseOrderItemsReceivedAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PurchaseOrderItemsReceivedAuditLogDTO)) {
            return false;
        }

        PurchaseOrderItemsReceivedAuditLogDTO purchaseOrderItemsReceivedAuditLogDTO = (PurchaseOrderItemsReceivedAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, purchaseOrderItemsReceivedAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "PurchaseOrderItemsReceivedAuditLogDTO{" +
