...
public class ItemInventoryStatusAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ItemInventoryStatusAuditLogDTO)) {
            return false;
        }

        ItemInventoryStatusAuditLogDTO itemInventoryStatusAuditLogDTO = (ItemInventoryStatusAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, itemInventoryStatusAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "ItemInventoryStatusAuditLogDTO{" +
