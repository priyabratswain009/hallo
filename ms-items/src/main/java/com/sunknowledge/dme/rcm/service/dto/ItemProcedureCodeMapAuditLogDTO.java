...
public class ItemProcedureCodeMapAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ItemProcedureCodeMapAuditLogDTO)) {
            return false;
        }

        ItemProcedureCodeMapAuditLogDTO itemProcedureCodeMapAuditLogDTO = (ItemProcedureCodeMapAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, itemProcedureCodeMapAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "ItemProcedureCodeMapAuditLogDTO{" +
