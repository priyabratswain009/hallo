...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.PriceDetailsAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class PriceDetailsAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PriceDetailsAuditLogDTO)) {
            return false;
        }

        PriceDetailsAuditLogDTO priceDetailsAuditLogDTO = (PriceDetailsAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, priceDetailsAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "PriceDetailsAuditLogDTO{" +
