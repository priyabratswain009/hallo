...
@JsonPropertyOrder({ "code", "name", "serviceTypeCodes", "serviceTypes", "benefitsAdditionalInformation",
		"benefitsDateInformation", "coverageLevelCode", "coverageLevel", "timeQualifierCode", "timeQualifier",
		"benefitPercent", "inPlanNetworkIndicatorCode", "inPlanNetworkIndicator", "benefitAmount" })
