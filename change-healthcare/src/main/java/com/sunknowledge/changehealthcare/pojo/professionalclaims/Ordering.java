...
@JsonPropertyOrder({ "address", "contactInformation", "providerType", "npi", "ssn", "employerId", "commercialNumber",
		"naic", "locationNumber", "payerIdentificationNumber", "employerIdentificationNumber", "claimOfficeNumber",
		"stateLicenseNumber", "providerUpinNumber", "taxonomyCode", "firstName", "lastName", "middleName",
		"organizationName" })
