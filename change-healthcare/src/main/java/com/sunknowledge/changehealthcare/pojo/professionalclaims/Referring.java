...
@JsonPropertyOrder({ "address", "contactInformation", "providerType", "npi", "ssn", "employerId", "commercialNumber",
		"locationNumber", "naic", "payerIdentificationNumber", "employerIdentificationNumber", "claimOfficeNumber",
		"stateLicenseNumber", "providerUpinNumber", "taxonomyCode", "firstName", "lastName", "organizationName",
		"middleName" })
