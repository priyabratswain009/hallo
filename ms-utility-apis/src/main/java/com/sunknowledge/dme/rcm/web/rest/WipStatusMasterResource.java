...
public class WipStatusMasterResource {
    ...
    private static final String ENTITY_NAME = "utilityapisWipStatusMaster";
    ...
    public ResponseEntity<WipStatusMasterDTO> createWipStatusMaster(@Valid @RequestBody WipStatusMasterDTO wipStatusMasterDTO)
    ...
    public ResponseEntity<WipStatusMasterDTO> updateWipStatusMaster(
        ...
        @Valid @RequestBody WipStatusMasterDTO wipStatusMasterDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<WipStatusMasterDTO> partialUpdateWipStatusMaster(
        @PathVariable(value = "wipStatusId", required = false) final Long wipStatusId,
        @NotNull @RequestBody WipStatusMasterDTO wipStatusMasterDTO
    ) throws URISyntaxException {
