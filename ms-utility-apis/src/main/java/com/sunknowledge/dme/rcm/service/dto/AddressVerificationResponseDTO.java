...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.AddressVerificationResponse} entity.
 */
public class AddressVerificationResponseDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AddressVerificationResponseDTO)) {
            return false;
        }

        AddressVerificationResponseDTO addressVerificationResponseDTO = (AddressVerificationResponseDTO) o;
        if (this.uspsAddressVerificationId == null) {
            return false;
        }
        return Objects.equals(this.uspsAddressVerificationId, addressVerificationResponseDTO.uspsAddressVerificationId);
    }
    ...
    public String toString() {
        return "AddressVerificationResponseDTO{" +
