...
class WipStatusMasterResourceIT {
    ...
    void createWipStatusMaster() throws Exception {
        ...
        assertThat(testWipStatusMaster.getTaskId()).isEqualTo(DEFAULT_TASK_ID);
        assertThat(testWipStatusMaster.getTaskName()).isEqualTo(DEFAULT_TASK_NAME);
    ...
    void putNewWipStatusMaster() throws Exception {
        ...
        assertThat(testWipStatusMaster.getTaskId()).isEqualTo(UPDATED_TASK_ID);
        assertThat(testWipStatusMaster.getTaskName()).isEqualTo(UPDATED_TASK_NAME);
    ...
    void partialUpdateWipStatusMasterWithPatch() throws Exception {
        ...
        partialUpdatedWipStatusMaster.status(UPDATED_STATUS).createdById(UPDATED_CREATED_BY_ID).createdDate(UPDATED_CREATED_DATE);
