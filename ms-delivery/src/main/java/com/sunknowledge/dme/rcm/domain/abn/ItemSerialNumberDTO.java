...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.ItemSerialNumber}
 * entity.
 */
...
public class ItemSerialNumberDTO implements Serializable {
	...
	public String toString() {
		return "ItemSerialNumberDTO{" + "itemSerialNumberId=" + getItemSerialNumberId() + ", itemId=" + getItemId()
				+ ", locationId=" + getLocationId() + ", serialNumber='" + getSerialNumber() + "'" + ", assetNumber='"
				+ getAssetNumber() + "'" + ", onHandStatus='" + getOnHandStatus() + "'" + ", purchaseDate='"
				+ getPurchaseDate() + "'" + ", saleDate='" + getSaleDate() + "'" + ", depreciationStatus='"
				+ getDepreciationStatus() + "'" + ", usefulLifeInYears=" + getUsefulLifeInYears()
				+ ", startDepreciationDate='" + getStartDepreciationDate() + "'" + ", originalCost=" + getOriginalCost()
				+ ", bookValue=" + getBookValue() + ", userValue1='" + getUserValue1() + "'" + ", userValue2='"
				+ getUserValue2() + "'" + ", userValue3='" + getUserValue3() + "'" + ", userValue4='" + getUserValue4()
				+ "'" + ", lotBatchNo='" + getLotBatchNo() + "'" + ", status='" + getStatus() + "'" + ", createdById="
				+ getCreatedById() + ", createdDate='" + getCreatedDate() + "'" + ", createdByName='"
				+ getCreatedByName() + "'" + ", updatedByName='" + getUpdatedByName() + "'" + ", updatedById="
				+ getUpdatedById() + ", itemSerialNumberUuid='" + getItemSerialNumberUuid() + "'" + ", itemNo='"
				+ getItemNo() + "'" + ", itemName='" + getItemName() + "'" + ", locationName='" + getLocationName()
				+ "'" + ", onRentStatus='" + getOnRentStatus() + "'" + ", lotBatchDate='" + getLotBatchDate() + "'"
				+ ", updatedDate='" + getUpdatedDate() + "'" + ", lotNo='" + getLotNo() + "'" + ", mfgDate='"
				+ getMfgDate() + "'" + ", poId=" + getPoId() + ", poNo='" + getPoNo() + "'" + ", adjustmentId="
				+ getAdjustmentId() + ", adjustmentNo='" + getAdjustmentNo() + "'" + "}";
	}
}
