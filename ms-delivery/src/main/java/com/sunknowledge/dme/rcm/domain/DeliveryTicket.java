...
public class DeliveryTicket implements Serializable {
    ...
    @Column(name = "delivery_ticket_id", nullable = false)
    ...
    @Column(name = "ordering_provider_middle_name")
    ...
    @Column(name = "ordering_provider_address_line_1")
    private String orderingProviderAddressLine1;

    @Column(name = "ordering_provider_address_line_2")
    private String orderingProviderAddressLine2;

    @Column(name = "ordering_provider_city")
    private String orderingProviderCity;

    @Column(name = "ordering_provider_state")
    private String orderingProviderState;

    @Column(name = "ordering_provider_zip")
    private String orderingProviderZip;

    @Column(name = "ordering_provider_phone_1")
    private String orderingProviderPhone1;

    @Column(name = "ordering_provider_phone_2")
    private String orderingProviderPhone2;

    @Column(name = "ordering_provider_fax")
    private String orderingProviderFax;

    @Column(name = "ordering_provider_email")
    private String orderingProviderEmail;

    @Column(name = "branch_name")
    private String branchName;

    @Column(name = "patient_branch_id")
    ...
    @Column(name = "delivery_ticket_uuid")
    ...
    @Column(name = "inventory_location_name")
    private String inventoryLocationName;

    @Column(name = "delivery_ticket_document_id")
    private Long deliveryTicketDocumentId;

    @Column(name = "delivery_ticket_document_no")
    private String deliveryTicketDocumentNo;

    @Column(name = "delivery_ticket_document_name")
