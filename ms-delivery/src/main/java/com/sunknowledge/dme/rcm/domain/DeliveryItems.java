...
public class DeliveryItems implements Serializable {
    ...
    @Column(name = "whether_item_serialized")
    private String whetherItemSerialized;

    @Column(name = "item_serial")
    private String itemSerial;

    @Column(name = "item_batch_lot_no")
    ...
    @Column(name = "delivery_items_uuid")
    ...
    @Column(name = "item_manufacturer_name")
