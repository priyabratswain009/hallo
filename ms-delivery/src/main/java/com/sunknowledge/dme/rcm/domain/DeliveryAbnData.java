 ...
 */
@Entity
@Table(name = "t_delivery_abn_data")
public class DeliveryAbnData implements Serializable {
    ...
    @Column(name = "delivery_abn_data_id")
    ...
    @Column(name = "primary_insurance_name")
    private String primaryInsuranceName;

    @Column(name = "primary_insurance_policy_number")
    ...
    @Column(name = "sales_order_details_abn_print_date")
    private LocalDate salesOrderDetailsAbnPrintDate;

    @Column(name = "sales_order_details_abn_item_name")
    private String salesOrderDetailsAbnItemName;

    @Column(name = "sales_order_details_abn_item_proc_code")
    private String salesOrderDetailsAbnItemProcCode;

    @Column(name = "sales_order_details_abn_item_charge_amount")
    private String salesOrderDetailsAbnItemChargeAmount;

    @Column(name = "sales_order_details_patient_abn_response")
    private String salesOrderDetailsPatientAbnResponse;

    @Column(name = "sales_order_details_abn_delivery_status")
    private String salesOrderDetailsAbnDeliveryStatus;

    @Column(name = "sales_order_details_abn_patient_signature_status")
    private String salesOrderDetailsAbnPatientSignatureStatus;

    @Column(name = "sales_order_details_abn_status")
    private String salesOrderDetailsAbnStatus;

    @Column(name = "sales_order_details_abn_reason")
    private String salesOrderDetailsAbnReason;

    @Column(name = "sales_order_details_abn_modifier_1")
    private String salesOrderDetailsAbnModifier1;

    @Column(name = "sales_order_details_abn_modifier_2")
    ...
    @Column(name = "delivery_abn_data_uuid")
