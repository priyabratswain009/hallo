...
public class PickupExchange implements Serializable {
    ...
    @Column(name = "pickup_exchange_id", nullable = false)
    private Long pickupExchangeId;

    @Column(name = "pickup_exchange_no")
    private String pickupExchangeNo;

    @Column(name = "pickup_exchange_type")
    ...
    @Column(name = "patient_contact_1")
    private String patientContact1;

    @Column(name = "patient_contact_2")
    private String patientContact2;

    @Column(name = "patient_billing_address_line_1")
    private String patientBillingAddressLine1;

    @Column(name = "patient_billing_address_line_2")
    private String patientBillingAddressLine2;

    @Column(name = "patient_billing_address_state")
    private String patientBillingAddressState;

    @Column(name = "patient_billing_address_city")
    private String patientBillingAddressCity;

    @Column(name = "patient_billing_address_zip")
    private String patientBillingAddressZip;

    @Column(name = "patient_delivey_address_line_1")
    private String patientDeliveyAddressLine1;

    @Column(name = "patient_delivey_address_line_2")
    private String patientDeliveyAddressLine2;

    @Column(name = "patient_delivey_address_state")
    private String patientDeliveyAddressState;

    @Column(name = "patient_delivey_address_city")
    private String patientDeliveyAddressCity;

    @Column(name = "patient_delivey_address_zip")
    private String patientDeliveyAddressZip;

    @Column(name = "pickup_exchange_schedule_date_time")
    private LocalDate pickupExchangeScheduleDateTime;

    @Column(name = "pickup_exchange_actual_date_time")
    private LocalDate pickupExchangeActualDateTime;

    @Column(name = "pickup_exchange_reason")
    private String pickupExchangeReason;

    @Column(name = "pickup_exchange_request")
    private String pickupExchangeRequest;

    @Column(name = "pickup_exchange_note")
    private String pickupExchangeNote;

    @Column(name = "pickup_exchange_agent_id_no")
    private String pickupExchangeAgentIdNo;

    @Column(name = "pickup_exchange_agent_name")
    private String pickupExchangeAgentName;

    @Column(name = "pickup_exchange_document_id")
    private String pickupExchangeDocumentId;

    @Column(name = "pickup_exchange_document_no")
    private String pickupExchangeDocumentNo;

    @Column(name = "pickup_exchange_document_name")
    private String pickupExchangeDocumentName;

    @Column(name = "pickup_exchange_status")
    private String pickupExchangeStatus;

    @Column(name = "pickup_exchange_comments")
    ...
    @Column(name = "patient_signed_date_time")
    private LocalDate patientSignedDateTime;

    @Column(name = "is_agent_signed")
    ...
    @Column(name = "pickup_exchange_supporting_document_1")
    private String pickupExchangeSupportingDocument1;

    @Column(name = "pickup_exchange_supporting_document_2")
    private String pickupExchangeSupportingDocument2;

    @Column(name = "patient_notsigned_reason")
    private String patientNotsignedReason;

    @Column(name = "pickup_exchange_json_data")
    ...
    @Column(name = "pickup_exchange_uuid")
