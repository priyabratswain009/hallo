...
/**
 * A ItemLocationAuditLog.
 */
@Entity
@Table(name = "t_item_location_audit_log")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class ItemLocationAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "itm_lction_id")
    private Long itmLctionId;
    ...
    public Long getItmLctionId() {
        return this.itmLctionId;
    }

    public ItemLocationAuditLog itmLctionId(Long itmLctionId) {
        this.setItmLctionId(itmLctionId);
        return this;
    }

    public void setItmLctionId(Long itmLctionId) {
        this.itmLctionId = itmLctionId;
    }
    ...
    public ItemLocationAuditLog oldRowData(String oldRowData) {
    ...
    public ItemLocationAuditLog newRowData(String newRowData) {
    ...
    public ItemLocationAuditLog dmlType(String dmlType) {
    ...
    public ItemLocationAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public ItemLocationAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public ItemLocationAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ItemLocationAuditLog)) {
            return false;
        }
        return id != null && id.equals(((ItemLocationAuditLog) o).id);
    }
