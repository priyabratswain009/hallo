...
/**
 * A BranchGroupAuditLog.
 */
@Entity
@Table(name = "t_branch_group_audit_log")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class BranchGroupAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "brnch_grp_id")
    ...
    public Long getBrnchGrpId() {
        return this.brnchGrpId;
    }

    public BranchGroupAuditLog brnchGrpId(Long brnchGrpId) {
        this.setBrnchGrpId(brnchGrpId);
        return this;
    }

    public void setBrnchGrpId(Long brnchGrpId) {
        this.brnchGrpId = brnchGrpId;
    }
    ...
    public BranchGroupAuditLog oldRowData(String oldRowData) {
    ...
    public BranchGroupAuditLog newRowData(String newRowData) {
    ...
    public BranchGroupAuditLog dmlType(String dmlType) {
    ...
    public BranchGroupAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public BranchGroupAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public BranchGroupAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BranchGroupAuditLog)) {
            return false;
        }
        return id != null && id.equals(((BranchGroupAuditLog) o).id);
    }
