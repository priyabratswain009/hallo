...
/**
 * A SalesOrderClassificationAuditLog.
 */
@Entity
...
public class SalesOrderClassificationAuditLog implements Serializable {
    ...
    @Column(name = "order_clafication_id")
    ...
    public Long getOrderClaficationId() {
        return this.orderClaficationId;
    }

    public SalesOrderClassificationAuditLog orderClaficationId(Long orderClaficationId) {
        this.setOrderClaficationId(orderClaficationId);
        return this;
    }
    ...
    public SalesOrderClassificationAuditLog oldRowData(String oldRowData) {
    ...
    public SalesOrderClassificationAuditLog newRowData(String newRowData) {
    ...
    public SalesOrderClassificationAuditLog dmlType(String dmlType) {
    ...
    public SalesOrderClassificationAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public SalesOrderClassificationAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public SalesOrderClassificationAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SalesOrderClassificationAuditLog)) {
            return false;
        }
        return id != null && id.equals(((SalesOrderClassificationAuditLog) o).id);
    }
