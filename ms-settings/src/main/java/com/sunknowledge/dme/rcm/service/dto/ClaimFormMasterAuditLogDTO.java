...
public class ClaimFormMasterAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClaimFormMasterAuditLogDTO)) {
            return false;
        }

        ClaimFormMasterAuditLogDTO claimFormMasterAuditLogDTO = (ClaimFormMasterAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, claimFormMasterAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "ClaimFormMasterAuditLogDTO{" +
