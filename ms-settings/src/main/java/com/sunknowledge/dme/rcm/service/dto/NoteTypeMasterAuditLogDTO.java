...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.NoteTypeMasterAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NoteTypeMasterAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NoteTypeMasterAuditLogDTO)) {
            return false;
        }

        NoteTypeMasterAuditLogDTO noteTypeMasterAuditLogDTO = (NoteTypeMasterAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, noteTypeMasterAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "NoteTypeMasterAuditLogDTO{" +
