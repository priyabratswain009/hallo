...
/**
 * A ClaimProgramMasterAuditLog.
 */
@Entity
@Table(name = "t_claim_program_master_audit_log")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class ClaimProgramMasterAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "insrnce_incator_id")
    private Long insrnceIncatorId;
    ...
    public Long getInsrnceIncatorId() {
        return this.insrnceIncatorId;
    }

    public ClaimProgramMasterAuditLog insrnceIncatorId(Long insrnceIncatorId) {
        this.setInsrnceIncatorId(insrnceIncatorId);
        return this;
    }

    public void setInsrnceIncatorId(Long insrnceIncatorId) {
        this.insrnceIncatorId = insrnceIncatorId;
    }
    ...
    public ClaimProgramMasterAuditLog oldRowData(String oldRowData) {
    ...
    public ClaimProgramMasterAuditLog newRowData(String newRowData) {
    ...
    public ClaimProgramMasterAuditLog dmlType(String dmlType) {
    ...
    public ClaimProgramMasterAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public ClaimProgramMasterAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public ClaimProgramMasterAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClaimProgramMasterAuditLog)) {
            return false;
        }
        return id != null && id.equals(((ClaimProgramMasterAuditLog) o).id);
    }
    ...
    public String toString() {
        return "ClaimProgramMasterAuditLog{" +
            "id=" + getId() +
            ", insrnceIncatorId=" + getInsrnceIncatorId() +
