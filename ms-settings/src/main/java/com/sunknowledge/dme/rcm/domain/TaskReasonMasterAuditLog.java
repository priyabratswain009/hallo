...
/**
 * A TaskReasonMasterAuditLog.
 */
@Entity
@Table(name = "t_task_reason_master_audit_log")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TaskReasonMasterAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "tsk_rason_id")
    ...
    public Long getTskRasonId() {
        return this.tskRasonId;
    }

    public TaskReasonMasterAuditLog tskRasonId(Long tskRasonId) {
        this.setTskRasonId(tskRasonId);
        return this;
    }

    public void setTskRasonId(Long tskRasonId) {
        this.tskRasonId = tskRasonId;
    }
    ...
    public TaskReasonMasterAuditLog oldRowData(String oldRowData) {
    ...
    public TaskReasonMasterAuditLog newRowData(String newRowData) {
    ...
    public TaskReasonMasterAuditLog dmlType(String dmlType) {
    ...
    public TaskReasonMasterAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public TaskReasonMasterAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public TaskReasonMasterAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaskReasonMasterAuditLog)) {
            return false;
        }
        return id != null && id.equals(((TaskReasonMasterAuditLog) o).id);
    }
