...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.TaxZoneAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TaxZoneAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaxZoneAuditLogDTO)) {
            return false;
        }

        TaxZoneAuditLogDTO taxZoneAuditLogDTO = (TaxZoneAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, taxZoneAuditLogDTO.id);
    }
