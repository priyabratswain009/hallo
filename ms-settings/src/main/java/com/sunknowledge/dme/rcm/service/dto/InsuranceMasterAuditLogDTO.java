...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.InsuranceMasterAuditLog} entity.
 */
public class InsuranceMasterAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InsuranceMasterAuditLogDTO)) {
            return false;
        }

        InsuranceMasterAuditLogDTO insuranceMasterAuditLogDTO = (InsuranceMasterAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, insuranceMasterAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "InsuranceMasterAuditLogDTO{" +
