...
/**
 * A StopReasonMasterAuditLog.
 */
@Entity
@Table(name = "t_stop_reason_master_audit_log")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class StopReasonMasterAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "stp_rason_id")
    private Long stpRasonId;
    ...
    public Long getStpRasonId() {
        return this.stpRasonId;
    }

    public StopReasonMasterAuditLog stpRasonId(Long stpRasonId) {
        this.setStpRasonId(stpRasonId);
        return this;
    }

    public void setStpRasonId(Long stpRasonId) {
        this.stpRasonId = stpRasonId;
    }
    ...
    public StopReasonMasterAuditLog oldRowData(String oldRowData) {
    ...
    public StopReasonMasterAuditLog newRowData(String newRowData) {
    ...
    public StopReasonMasterAuditLog dmlType(String dmlType) {
    ...
    public StopReasonMasterAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public StopReasonMasterAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public StopReasonMasterAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopReasonMasterAuditLog)) {
            return false;
        }
        return id != null && id.equals(((StopReasonMasterAuditLog) o).id);
    }
