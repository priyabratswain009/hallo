...
public class BranchGroupAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BranchGroupAuditLogDTO)) {
            return false;
        }

        BranchGroupAuditLogDTO branchGroupAuditLogDTO = (BranchGroupAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, branchGroupAuditLogDTO.id);
    }
