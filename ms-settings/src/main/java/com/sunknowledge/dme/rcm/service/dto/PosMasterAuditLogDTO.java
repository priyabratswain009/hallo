...
public class PosMasterAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PosMasterAuditLogDTO)) {
            return false;
        }

        PosMasterAuditLogDTO posMasterAuditLogDTO = (PosMasterAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, posMasterAuditLogDTO.id);
    }
