...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.BranchInsuranceMapAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class BranchInsuranceMapAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BranchInsuranceMapAuditLogDTO)) {
            return false;
        }

        BranchInsuranceMapAuditLogDTO branchInsuranceMapAuditLogDTO = (BranchInsuranceMapAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, branchInsuranceMapAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "BranchInsuranceMapAuditLogDTO{" +
