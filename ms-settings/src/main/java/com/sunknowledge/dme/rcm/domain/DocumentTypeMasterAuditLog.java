...
/**
 * A DocumentTypeMasterAuditLog.
 */
@Entity
@Table(name = "t_document_type_master_audit_log")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class DocumentTypeMasterAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "dcumet_tpe_id")
    ...
    public Long getDcumetTpeId() {
        return this.dcumetTpeId;
    }

    public DocumentTypeMasterAuditLog dcumetTpeId(Long dcumetTpeId) {
        this.setDcumetTpeId(dcumetTpeId);
        return this;
    }
    ...
    public DocumentTypeMasterAuditLog oldRowData(String oldRowData) {
    ...
    public DocumentTypeMasterAuditLog newRowData(String newRowData) {
    ...
    public DocumentTypeMasterAuditLog dmlType(String dmlType) {
    ...
    public DocumentTypeMasterAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public DocumentTypeMasterAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public DocumentTypeMasterAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DocumentTypeMasterAuditLog)) {
            return false;
        }
        return id != null && id.equals(((DocumentTypeMasterAuditLog) o).id);
    }
