...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.ClaimProgramMasterAuditLog} entity.
 */
public class ClaimProgramMasterAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ClaimProgramMasterAuditLogDTO)) {
            return false;
        }

        ClaimProgramMasterAuditLogDTO claimProgramMasterAuditLogDTO = (ClaimProgramMasterAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, claimProgramMasterAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "ClaimProgramMasterAuditLogDTO{" +
