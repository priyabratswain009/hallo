 ...
 */
@Entity
@Table(name = "t_pos_master_audit_log")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class PosMasterAuditLog implements Serializable {
    ...
    public PosMasterAuditLog psId(Long psId) {
        this.setPsId(psId);
        return this;
    }
    ...
    public PosMasterAuditLog oldRowData(String oldRowData) {
    ...
    public PosMasterAuditLog newRowData(String newRowData) {
    ...
    public PosMasterAuditLog dmlType(String dmlType) {
    ...
    public PosMasterAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public PosMasterAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public PosMasterAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PosMasterAuditLog)) {
            return false;
        }
        return id != null && id.equals(((PosMasterAuditLog) o).id);
    }
