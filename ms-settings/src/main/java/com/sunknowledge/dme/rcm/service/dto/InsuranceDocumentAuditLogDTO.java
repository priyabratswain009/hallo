...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.InsuranceDocumentAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InsuranceDocumentAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InsuranceDocumentAuditLogDTO)) {
            return false;
        }

        InsuranceDocumentAuditLogDTO insuranceDocumentAuditLogDTO = (InsuranceDocumentAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, insuranceDocumentAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "InsuranceDocumentAuditLogDTO{" +
