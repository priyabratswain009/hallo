...
/**
 * A InsuranceMasterAuditLog.
 */
@Entity
@Table(name = "t_insurance_master_audit_log")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class InsuranceMasterAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "insrnce_id")
    private Long insrnceId;
    ...
    public Long getInsrnceId() {
        return this.insrnceId;
    }

    public InsuranceMasterAuditLog insrnceId(Long insrnceId) {
        this.setInsrnceId(insrnceId);
        return this;
    }

    public void setInsrnceId(Long insrnceId) {
        this.insrnceId = insrnceId;
    }
    ...
    public InsuranceMasterAuditLog oldRowData(String oldRowData) {
    ...
    public InsuranceMasterAuditLog newRowData(String newRowData) {
    ...
    public InsuranceMasterAuditLog dmlType(String dmlType) {
    ...
    public InsuranceMasterAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public InsuranceMasterAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public InsuranceMasterAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InsuranceMasterAuditLog)) {
            return false;
        }
        return id != null && id.equals(((InsuranceMasterAuditLog) o).id);
    }
