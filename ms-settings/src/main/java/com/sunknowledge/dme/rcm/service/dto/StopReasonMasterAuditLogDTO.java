...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.StopReasonMasterAuditLog} entity.
 */
public class StopReasonMasterAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StopReasonMasterAuditLogDTO)) {
            return false;
        }

        StopReasonMasterAuditLogDTO stopReasonMasterAuditLogDTO = (StopReasonMasterAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, stopReasonMasterAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "StopReasonMasterAuditLogDTO{" +
