...
/**
 * A InsuranceDocumentAuditLog.
 */
@Entity
@Table(name = "t_insurance_document_audit_log")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class InsuranceDocumentAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "inrance_docmet_id")
    private Long inranceDocmetId;
    ...
    public Long getInranceDocmetId() {
        return this.inranceDocmetId;
    }

    public InsuranceDocumentAuditLog inranceDocmetId(Long inranceDocmetId) {
        this.setInranceDocmetId(inranceDocmetId);
        return this;
    }

    public void setInranceDocmetId(Long inranceDocmetId) {
        this.inranceDocmetId = inranceDocmetId;
    }
    ...
    public InsuranceDocumentAuditLog oldRowData(String oldRowData) {
    ...
    public InsuranceDocumentAuditLog newRowData(String newRowData) {
    ...
    public InsuranceDocumentAuditLog dmlType(String dmlType) {
    ...
    public InsuranceDocumentAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public InsuranceDocumentAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public InsuranceDocumentAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InsuranceDocumentAuditLog)) {
            return false;
        }
        return id != null && id.equals(((InsuranceDocumentAuditLog) o).id);
    }
    ...
    public String toString() {
        return "InsuranceDocumentAuditLog{" +
            "id=" + getId() +
            ", inranceDocmetId=" + getInranceDocmetId() +
