...
public class UserMaster implements Serializable {
    ...
    public UserMaster userId(Long userId) {
    ...
    public UserMaster middleName(String middleName) {
    ...
    public UserMaster dob(LocalDate dob) {
        this.setDob(dob);
        return this;
    }
    ...
    public UserMaster age(Long age) {
        this.setAge(age);
        return this;
    }
    ...
    public UserMaster status(String status) {
    ...
    public UserMaster createdById(Long createdById) {
    ...
    public UserMaster createdDate(LocalDate createdDate) {
    ...
    public UserMaster createdByName(String createdByName) {
    ...
    public UserMaster updatedByName(String updatedByName) {
    ...
    public UserMaster updatedById(Long updatedById) {
    ...
    public UUID getUserMasterUuid() {
        return this.userMasterUuid;
    }

    public UserMaster userMasterUuid(UUID userMasterUuid) {
        this.setUserMasterUuid(userMasterUuid);
        return this;
    }
    ...
    public UserMaster addressLine1(String addressLine1) {
    ...
    public UserMaster addressLine2(String addressLine2) {
    ...
    public UserMaster city(String city) {
        this.setCity(city);
        return this;
    }
    ...
    public UserMaster state(String state) {
        this.setState(state);
        return this;
    }
    ...
    public UserMaster country(String country) {
    ...
    public UserMaster zip(String zip) {
        this.setZip(zip);
        return this;
    }
    ...
    public UserMaster contactNo1(String contactNo1) {
    ...
    public UserMaster contactNo2(String contactNo2) {
    ...
    public UserMaster fax(String fax) {
        this.setFax(fax);
        return this;
    }
    ...
    public UserMaster efax(String efax) {
        this.setEfax(efax);
        return this;
    }
    ...
    public UserMaster email(String email) {
        this.setEmail(email);
        return this;
    }
    ...
    public UserMaster jobTitle(String jobTitle) {
    ...
    public UserMaster modeOfContact(String modeOfContact) {
    ...
    public boolean equals(Object o) {
        ...
        return userId != null && userId.equals(((UserMaster) o).userId);
    }
