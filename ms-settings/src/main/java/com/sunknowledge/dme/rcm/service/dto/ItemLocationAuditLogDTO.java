...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.ItemLocationAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ItemLocationAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ItemLocationAuditLogDTO)) {
            return false;
        }

        ItemLocationAuditLogDTO itemLocationAuditLogDTO = (ItemLocationAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, itemLocationAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "ItemLocationAuditLogDTO{" +
