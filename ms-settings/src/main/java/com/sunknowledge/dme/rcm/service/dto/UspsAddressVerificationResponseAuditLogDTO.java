...
public class UspsAddressVerificationResponseAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UspsAddressVerificationResponseAuditLogDTO)) {
            return false;
        }

        UspsAddressVerificationResponseAuditLogDTO uspsAddressVerificationResponseAuditLogDTO = (UspsAddressVerificationResponseAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, uspsAddressVerificationResponseAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "UspsAddressVerificationResponseAuditLogDTO{" +
