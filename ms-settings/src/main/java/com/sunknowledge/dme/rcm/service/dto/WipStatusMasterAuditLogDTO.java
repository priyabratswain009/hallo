...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.WipStatusMasterAuditLog} entity.
 */
public class WipStatusMasterAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WipStatusMasterAuditLogDTO)) {
            return false;
        }

        WipStatusMasterAuditLogDTO wipStatusMasterAuditLogDTO = (WipStatusMasterAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, wipStatusMasterAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "WipStatusMasterAuditLogDTO{" +
