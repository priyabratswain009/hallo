...
/**
 * A DTO for the {@link com.sunknowledge.dme.rcm.domain.InsuranceGroupMasterAuditLog} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InsuranceGroupMasterAuditLogDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InsuranceGroupMasterAuditLogDTO)) {
            return false;
        }

        InsuranceGroupMasterAuditLogDTO insuranceGroupMasterAuditLogDTO = (InsuranceGroupMasterAuditLogDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, insuranceGroupMasterAuditLogDTO.id);
    }
    ...
    public String toString() {
        return "InsuranceGroupMasterAuditLogDTO{" +
