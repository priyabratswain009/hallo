...
/**
 * A WipStatusMasterAuditLog.
 */
@Entity
@Table(name = "t_wip_status_master_audit_log")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class WipStatusMasterAuditLog implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "wp_sttus_id")
    private Long wpSttusId;
    ...
    public Long getWpSttusId() {
        return this.wpSttusId;
    }

    public WipStatusMasterAuditLog wpSttusId(Long wpSttusId) {
        this.setWpSttusId(wpSttusId);
        return this;
    }

    public void setWpSttusId(Long wpSttusId) {
        this.wpSttusId = wpSttusId;
    }
    ...
    public WipStatusMasterAuditLog oldRowData(String oldRowData) {
    ...
    public WipStatusMasterAuditLog newRowData(String newRowData) {
    ...
    public WipStatusMasterAuditLog dmlType(String dmlType) {
    ...
    public WipStatusMasterAuditLog dmlTimestamp(LocalDate dmlTimestamp) {
    ...
    public WipStatusMasterAuditLog dmlCreatedBy(String dmlCreatedBy) {
    ...
    public WipStatusMasterAuditLog id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WipStatusMasterAuditLog)) {
            return false;
        }
        return id != null && id.equals(((WipStatusMasterAuditLog) o).id);
    }
